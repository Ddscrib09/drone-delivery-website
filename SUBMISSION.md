...
1. Online (recommended): open the URL above — it is served via GitHub Pages from the `docs/` folder on the `main` branch.
2. Locally: run this from the project root and open http://localhost:8000/ in your browser:

```bash
cd /workspaces/drone-delivery-website
...
Contact:
 ...
 - Repo: https://github.com/Ddscrib09/drone-delivery-website
